...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setStyleSheet("background-color: #26F0F1;")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Pnemonia Detection Application"))
        self.label.setToolTip(_translate("MainWindow", "<html><head/><body><p><img src=\":/newPrefix/picture.gif\"/></p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "Pnemonia Detection Application "))
        self.pushButton.setText(_translate("MainWindow", "Upload Image of Xray"))
        self.pushButton_2.setText(_translate("MainWindow", "Predict The Results"))
    ...
    def predict_result(self):
        print(result)
        if result[0][0]>0.5:
            print("Result is Normal, The patient is not affected by Pnemonia")
            speak("Result is Normal, The patient is not affected by pnemonia. have a safe day!!")
        else:
            print("The Person is Affected by pneumonia , kindly take the required treatments")
            speak("The Person is Affected by pneumonia , kindly take the required treatments or visit a nearby hospital soon . Take Care!")
